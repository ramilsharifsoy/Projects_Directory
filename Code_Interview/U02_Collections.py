# Array is a list with additional properties
# Arrays have different properties in different languages
# Array has loacations called index - defference from lists
# Deletion and addition moves boxes - can be inefficient
# Runtime = How many times computation needs to be iterated multiplied by time needed to run one computation
# Doubly Linkedin Lists >> next >> previous
...
# Should print 3 now
print (ll.get_position(3).value)
# Should print None now
print (ll.get_position(0)) # None doesnot have value
